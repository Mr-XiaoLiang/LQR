 ...
 * @author Lollipop
 */
class ColorPickerDialog2 private constructor(context: Context, private val lastColor:Int,
    ...
    companion object {
        ...
        fun create(context: Context,lastColor: Int,
                   onColorSelectedListener: OnColorSelectedListener):ColorPickerDialog2{
            return ColorPickerDialog2(context,lastColor,onColorSelectedListener)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_color_picker2)
    ...
    interface OnColorSelectedListener{
        fun onColorSelected(dialog: ColorPickerDialog2, color:Int)
    }
