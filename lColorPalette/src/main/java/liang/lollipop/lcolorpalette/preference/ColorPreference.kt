package liang.lollipop.lcolorpalette.preference
...
import liang.lollipop.lcolorpalette.ColorPickerDialog2
import liang.lollipop.lcolorpalette.R
...
class ColorPreference(context: Context, attrs: AttributeSet?,
    ...
    : DialogPreference(context,attrs,defStyleAttr),ColorPickerDialog2.OnColorSelectedListener {
    ...
    companion object {
        ...
        private val COLOR_WIDGET = R.layout.preference_color
    ...
    init {
        ...
        val a:TypedArray = context.obtainStyledAttributes(
                attrs, R.styleable.ColorPreference, defStyleAttr,0)
...
//    }
    ...
    override fun onColorSelected(dialog: ColorPickerDialog2, color: Int) {
